    ...
    return (
        <div className="menu-container">
            <MenuSection type="top">
                <MenuItem icon={require("../../icons/New tab16px.svg").default} name="New tab"/>
                <MenuItem icon={require("../../icons/New window 16px.svg").default} name="New window"/>
            ...
            <MenuSection title="Appearance">
                <ThemeItem/>
                <MenuItem icon={require("../../icons/Show Bookmarks 16px.svg").default} name="f-Show bookmarks bar"/>
                <MenuItem icon={require("../../icons/Home 16px.svg").default} name="Show home"/>
            </MenuSection>
            <MenuSection title="Start page">
                <MenuItem icon={require("../../icons/Most visited sites 16px.svg").default} name="f-Most visited sites"/>
            ...
            <MenuSection title="Privacy settings">
                <MenuItem icon={require("../../icons/Block ads 16 px.svg").default} name="f-Block ads"/>
                <MenuItem icon={require("../../icons/Block trackers 16px.svg").default} name="f-Block trackers"/>
                <MenuItem icon={require("../../icons/Clear browsing data 16x.svg").default} name="f-Clear browsing data"/>
